...
module.exports = {
  ...
  rescheduleConsultation: async (req, res) => {
    try {
      ...
      const now = new Date();
      const isValidNotice = (0, consultation_utils_1.isWorkingDayNotice)(
  ...
  getAvailableDates: async (req, res) => {
    try {
      ...
      const availableDates = (0, consultation_utils_1.generateWorkingDays)(
        startDate,
        daysInMonth
      );
  ...
  getAvailableTimeSlots: async (req, res) => {
    try {
      ...
      const availableTimeSlots = (0,
      consultation_utils_1.generateAvailableTimeSlots)(consults, sprints);
